...
<head>
    ...
    <meta name="description" content="Lịch phim châu Á theo giờ Việt Nam, đối chiếu tên Việt từ TMDB.">
    <meta name="theme-color" content="#d84132">
    <title>Lịch Phim Châu Á</title>
    <link rel="icon" href="/favicon.svg" type="image/svg+xml">
    <link rel="stylesheet" href="/assets/calendar.css?v=3">
    <script>
        window.calendarConfig = {
            apiUrl: @json(route('api.calendar')),
        };
    </script>
    <script src="/assets/calendar.js?v=2" defer></script>
</head>
<body>
    <header class="site-header">
        <a class="brand" href="/" aria-label="Lịch Phim Châu Á">
            <span class="brand-mark" aria-hidden="true">日</span>
            <span><strong>LỊCH PHIM</strong><small>Châu Á</small></span>
        </a>
        <div class="source-note"><span></span>Cập nhật từ MyDramaList</div>
    </header>
        ...
        <section class="hero">
            <div>
                ...
                <p class="hero-description">
                    Lịch phim châu Á theo giờ Việt Nam, với tên tiếng Việt
    ...
    <footer>
        <div><strong>LỊCH PHIM CHÂU Á</strong><p>Đúng giờ Việt · Đúng tên Việt</p></div>
        <p>
            Lịch phát sóng từ MyDramaList. Tên và hình ảnh từ TMDB.
